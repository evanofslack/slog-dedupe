...
func TestHashMapFilterAddTest(t *testing.T) {
	f := NewHashMapFilter()
...
func TestHashMapFilterReset(t *testing.T) {
	f := NewHashMapFilter()
...
func TestHashMapFilterMultipleHashes(t *testing.T) {
	f := NewHashMapFilter()
...
func TestHashMapFilterFalsePositiveRate(t *testing.T) {
	if testing.Short() {
		t.Skip("skipping false positive rate test in short mode")
	}
	
	f := NewHashMapFilterWithCapacity(10000)
...
func BenchmarkHashMapFilterAdd(b *testing.B) {
	f := NewHashMapFilter()
	b.ResetTimer()
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
...
func BenchmarkHashMapFilterTest(b *testing.B) {
	f := NewHashMapFilter()
	for i := 0; i < 1000; i++ {
		f.Add(uint64(i))
	}
...
func BenchmarkHashMapFilterAddAndTest(b *testing.B) {
	f := NewHashMapFilter()
	b.ResetTimer()
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
